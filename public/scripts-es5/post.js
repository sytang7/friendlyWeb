...
friendlyPix.Post = function () {
  ...
  /**
    ...
    nextPage) {var _this3 = this;
      ...
      if (nextPage) {
        ...
        nextPageButton.click(function () {return nextPage().then(function (data) {
            ...
            _this3.displayNextPageButton(data.nextPage);
          });});
      } else {
        nextPageButton.hide();
      }
    ...
    thumbUrl, picUrl) {var _this6 = this;
      ...
      $('.fp-image', post).click(function () {return _this6.enterTheatreMode(picUrl || thumbUrl);});
    }
    ...
    postId, author, imageText) {var _this7 = this;
      var post = this.postElement;
      ...
      friendlyPix.firebase.getComments(postId).then(function (data) {
        _this7.displayComments(data.entries);
        _this7.displayNextPageButton(data.nextPage);
    ...
    postId, author, picStorageUri, thumbStorageUri) {var _this8 = this;
      var post = this.postElement;
        ...
        $('.fp-delete-post', post).click(function () {
          ...
          function () {
            ...
            friendlyPix.firebase.deletePost(postId, picStorageUri, thumbStorageUri).then(function () {
              ...
              page('/user/' + _this8.auth.currentUser.uid);
